...
class Main extends Component {
    ...
    handleChooseCity=()=>{
        this.setState(s=>({choosingCity:!s.choosingCity}))
    }
    render() {
        // return(
        //     <SpotApp/>
        ...
        return (
            <HashRouter>
                ...
                <button onClick={this.handleChooseCity}>縣市景點列表</button>
        ...
        //             </div>
        //             <hr />
        //             <Route exact path="/scenicSpot" component={SpotApp} />
        //             <Route path="/scenicSpot/:City" component={SpotCity} />
        //         </div>
        //     </HashRouter>
        // )
        // return (
